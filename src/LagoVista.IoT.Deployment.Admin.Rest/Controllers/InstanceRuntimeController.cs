...
// ContentHash: a068cf4396fe7c09b0ef0511081101808d18f8546fbdeca73f1a53ccc3ba4729
// IndexVersion: 0
// --- END CODE INDEX META ---
...
namespace LagoVista.IoT.Deployment.Admin.Rest.Controllers
{
    public class InstanceRuntimeController : Controller
    {
        ...
        public async Task<InvokeResult<Device>> DeviceOfflineAsync([FromBody] Device device, string lastcontact)
        {
            await ValidateRequest(HttpContext.Request);
